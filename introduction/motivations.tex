...
From its first releases, and during several years, \windex{Linux} has been quite 
...
\windex[websockets]{websocket}, a full duplex communication between a browser and a web server 
